...
<body>
    ...
    <div class="w-full h-[70px] flex justify-between items-center p-3  bg-gradient-to-r from-indigo-500 to-purple-900 border-2 ">
      ...
      <div class=" flex justify-center items-center gap-[40px] ">
        ...
        <div class="flex">
          <div>
            <input class=" w-[300px] border-2 border-black rounded-2xl p-2 bg-red-200  mr-2" type="text" placeholder="search...">
          </div>
          <div class="flex w-[55px] justify-center items-center bg-red-200 rounded-full border-2 border-black ">
