...
<div style="background-image: url('./img/bg2.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;" class="relative flex flex-col justify-center items-center min-w-screen h-screen ">
    ...
    <div style="background-image: url('./img/bg2.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;" class="relative flex justify-center items-center min-w-screen h-screen ">
        <div id="b" class="flex flex-col lg:flex-row h-4/5 w-4/5 bg-amber-50 rounded-2xl overflow-hidden border shadow-2xl shadow-black z-20 ">
            <div class="bg-white h-full w-full lg:w-2/5 lg:h-full flex flex-col p-4 gap-7">
                ...
                <div id="a" class=" flex flex-col justify-center items-center text-2xl " >
                    <form action="/Project/signup.php" method="post">
                        <div class=" flex gap-[13px] mb-[10px]" >
                            ...
                            <input type="text" id="name" name="name" class="w-80 h-10 border-2 px-2 placeholder:text-[16px] rounded-xl text-[16px]"  placeholder="name..." >
                        </div>
                        <div class=" flex gap-[20px] mb-[10px]" >
                            <label for="email"><i class="fa-solid fa-envelope"></i></label>
                            <input type="text" id="email" name="email" class="w-80 h-10 border-2 px-2 placeholder:text-[16px] rounded-xl text-[16px]"  placeholder="email..." >
                        </div>
                        <div class=" flex gap-[20px] mb-[10px]">
                            <label class="pr-[3px]" for="password"><i class="fa-solid fa-lock"></i></label>
                            <input type="password" name="password" id="password" class="w-80 h-10 border-2 px-2 placeholder:text-[16px] text-[16px] rounded-xl " placeholder="password...">
                        </div>
                        <div class=" flex gap-[20px] mb-[40px]">
                            <input type="password" id="confirmpassword" name="confirmpassword" class="w-80 h-10 border-2 px-2 placeholder:text-[16px] text-[16px] rounded-xl ml-[44px] " placeholder="confirm password...">
                        </div>
                        ...
                        <div class="gap-[10px] mb-[5px] flex justify-center items-center">
                            ...
                            <div class="flex items-center gap-[5px]">
                                <input type="radio" name="permission" id="applicant" class="accent-amber-500" value="0">
                                <label class="text-[15px]" for="applicant">Applicant</label>
                            </div>
                            <div class="flex items-center gap-[5px]">
                                <input type="radio" name="permission" id="recruiter" class="accent-amber-500" value="1">
                                <label class="text-[15px]" for="recruiter">Recruiter</label>
                            </div>
                        </div>
                        
                        <div class=" flex justify-center ">
                            <button type="sumbit" class=" bg-amber-400 border-2 py-2 px-4 text-[20px] rounded-2xl hover:bg-amber-600" >signup</button>
                        </div>
                    </form>
                </div>
                ...
                <div id="a" class=" flex justify-center  " >
                    <pre>Already have an account...! </pre><a href="login.php"> <pre class=" text-amber-400  ">LogIn</pre> </a>
                </div>
