...
<div style="background-image: url('./img/bg1.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;" class="relative flex flex-col min-w-screen h-screen items-center justify-center ">
    ...
    <div style="background-image: url('./img/bg1.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;" class="relative flex justify-center items-center min-w-screen h-screen bg-indigo-500  ">
        <div id="b" class="flex flex-col lg:flex-row h-4/5 w-4/5 bg-amber-50 rounded-2xl overflow-hidden border shadow-2xl shadow-black z-20  ">
            <div class="bg-white h-full w-full lg:w-2/5 lg:h-full flex flex-col p-4 gap-7">
                ...
                <div id="a" class=" flex flex-col justify-center items-center text-2xl " >
                    <form action="/Project/login.php" method="post">
                        ...
                        <div class=" flex gap-[20px] mb-[40px]">
                            ...
                            <input type="password" id="password" name="password" class="w-80 h-10 border-2 px-2 placeholder:text-[16px] text-[16px] rounded-xl " placeholder="password...">
                        </div>
                        <div class=" flex justify-center ">
                            <button type="submit" class=" bg-indigo-500 border-2 py-2 px-4 text-[20px] rounded-2xl hover:bg-indigo-600" >Login</button>
                        </div>
                    </form>
                </div>
                ...
                <div id="a" class=" flex justify-center  " >
                    <pre>Don't have an account...! </pre><a href="/Project/signup.php"> <pre class=" text-indigo-800 ">SignUp</pre> </a>
                </div>
